const config = {
    ...
    apiKey: '...', // API Key of the Civi-User used to import the Data. Refer to twingle Documentation for further Information.
    siteKey: '...', // Site Key for your CiviCRM. Refer to twingle Documentation for further Information.
    debugMode: false, // True will only fill a logfile with the raw API-Calls. Set to false when you want to make actual API calls
